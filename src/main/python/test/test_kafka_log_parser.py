...
def test_parse_info():
    ...
    log_level = "INFO"
    line = f"kafka3: onNext: RAW: [{timestamp}] {log_level} [GroupCoordinator 3]: Resigned as the group coordinator for partition 8 in epoch OptionalInt[1] (kafka.coordinator.group.GroupCoordinator)"
    log = LogLine(line)
